...
export function Legend() {
  ...
  return (
    <div className="pointer-events-none absolute right-2 top-2 flex flex-col gap-1 rounded border border-slate-800 bg-slate-900/80 px-2.5 py-2 text-[10px] leading-tight">
      {isAggregate ? (
        <>
          <div className="font-semibold uppercase tracking-wider text-slate-500">{modeLabel} density</div>
          ...
          <div className="mt-1 border-t border-slate-800 pt-1 font-semibold uppercase tracking-wider text-slate-500">Events</div>
          {EVENT_ORDER.map((cat) => (
        ...
        <>
          <div className="font-semibold uppercase tracking-wider text-slate-500">Paths</div>
