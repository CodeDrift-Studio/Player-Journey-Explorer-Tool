...
export function HeatmapControl() {
  ...
  return (
    <div className="shrink-0">
        ...
        {HEATMAP_MODES.map((m) => {
          ...
          return (
            <button
              ...
              aria-pressed={active}
              className={`flex items-center gap-2 rounded-md px-2.5 py-1.5 text-left text-[0.8125rem] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-indigo-400 ${
      ...
      <div className="mt-2.5 flex items-center gap-1.5 text-[0.6875rem] text-slate-500">
        <span>low</span>
        <span
          aria-hidden
